...
const CATEGORY_MAP = {
  'Sanitation':      { dept: 'Sanitation & Solid Waste Management', icon: '' },
      ...
      <div style={styles.container}>
        ...
        <div style={styles.grid}>
          ...
          <div>
            ...
            <div style={{ ...styles.card, marginTop: 16 }}>
              <div style={styles.cardTitle}>{tx(' How It Works', lang)}</div>
              {[
